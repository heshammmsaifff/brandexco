...
function ContactPage({ lang }) {
  ...
  const title =
    lang === "ar"
      ? "تواصل معنا - BrandExCo | احصل على استشارة مجانية"
      : "Contact Us - BrandExCo | Get Free Consultation";

  const description =
    lang === "ar"
      ? "تواصل معنا للحصول على استشارة مجانية في التسويق الرقمي وتطوير المواقع. نقدم حلول مخصصة لنجاح عملك."
      : "Contact us for a free consultation in digital marketing and web development. We provide customized solutions for your business success.";

  const keywords =
    lang === "ar"
      ? "تواصل معنا, استشارة مجانية, تسويق رقمي, تطوير مواقع, براندكسكو, الرياض, السعودية"
      : "contact us, free consultation, digital marketing, web development, brandexco, riyadh, saudi arabia";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://brandexco.com/contact" />
        <meta
          property="og:image"
          content="https://brandexco.com/contact-og-image.jpg"
        />
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="name"
                  className="block text-brand-gray font-medium mb-3 text-lg"
                >
            ...
            <div className="bg-brand-black/50 rounded-xl p-8 border border-brand-gray/20">
              ...
              <div className="space-y-4">
                ...
                <div className="text-center mt-6">
                  <h4 className="font-bold text-brand-gray text-xl">
                    BRANDEXCO
                  </h4>
                </div>
              </div>
