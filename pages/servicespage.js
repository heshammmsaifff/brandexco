...
import ElectricBorder from "../components/ElectricBorder.js";
    ...
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content={
            lang === "ar" ? "خدماتنا - BrandExCo" : "Our Services - BrandExCo"
          }
        />
        <meta
          ...
          content={
            lang === "ar"
              ? "اكتشف خدماتنا الشاملة في تصميم المواقع، التسويق الرقمي، تطوير التطبيقات، وإدارة العلامات التجارية"
              : "Discover our comprehensive services in web design, digital marketing, app development, and branding"
          }
        />
        <meta property="og:url" content="https://brandexco.com/services" />
        <meta
          property="og:image"
          content="https://brandexco.com/services-og-image.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              availableChannel: {
                "@type": "ServiceChannel",
                serviceUrl: "https://brandexco.com/services",
              },
            }),
          }}
        />
